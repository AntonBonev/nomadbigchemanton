...
```sh
curl -L -o nomad-oasis.zip "https://github.com/AntonBonev/nomadbigchemanton/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/AntonBonev/nomadbigchemanton/manifests/main": unauthorized`
